  ...
  return (
    <div className="h-32 w-full flex items-center justify-between">
      ...
      <div id="information" className="mr-12 space-x-6">
        ...
        <FontAwesomeIcon className='hover:cursor-pointer' onClick={openInfoModal} color="#333" size="2xl" icon={faCircleInfo} />
        {/* GitHub icon */}
        <a href='https://github.com/kqwq/mod-pizza-quizzer' target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon color="#333" size="2xl" icon={faGithub} />
        </a>
